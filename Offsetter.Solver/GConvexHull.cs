...
using System.Linq;
using System.Windows.Forms;  // This is required to expose ElementA()

namespace Offsetter.Solver
{
    using GChainList = List<GChain>;

    public class GConvexHull
    {
        public GConvexHull(bool nesting) { this.nesting = nesting; }
        ...
        //
        //    file:///C:/_sandbox/Offsetter/data/nest02c-sans-filter.png
        //    file:///C:/_sandbox/Offsetter/data/nest02c-with-filter.png
        //
                ...
                if (!okay)
                {
                    ...
                    if (prev.IsA(T.LINE) && curr.IsA(T.LINE))
                    {
                        ...
                        else
                        {
                            ...
                            //    file:///C:/_sandbox/Offsetter/data/nest02c-interference.png
                            //
                            // With this code block:
                            //    file:///C:/_sandbox/Offsetter/data/nest02c-no-interference.png
                            //
                    ...
                    if (!curr.IsA(T.SUBCHN) && !next.IsA(T.SUBCHN) && curr.ps.WithinTol(next.ps))
                    {
                        ...
                        // The #ref(s) correlate with file:///C:/_sandbox/Offsetter/data/nest05a.png
        ...
        // named such only to simplify understanding in the context of ConvexHull
        ...
        {
            GLogger.Assert((part != tool), "GConvexHull.IntersectionsFind(part, tool, desired)");
            if (part == tool)
                return false;
